...
import {
  ...
  ChevronLeft, ChevronRight, Zap, Timer, BookOpen, Grid, ShieldCheck, Repeat
} from 'lucide-react';
...
const navItems = [
  ...
  { path: '/pomodoro', icon: Timer, BookOpen, Grid, ShieldCheck, Repeat, label: 'pomodoro' },
...
const labels = {
  uz: { dashboard: 'Asosiy', dailyPlanner: 'Kunlik reja', weeklyPlanner: 'Haftalik', monthlyPlanner: 'Oylik', yearlyGoals: 'Maqsadlar', habitTracker: 'Odatlar', notes: 'Yozuvlar', analytics: 'Statistika', achievements: 'Yutuqlar', location: 'Xarita', smartPlan: 'Aqlli reja', pomodoro: 'Pomodoro', journal: 'Kundalik', matrix: 'Matritsa', focus: 'Fokus', recurring: 'Takroriy' },
  ru: { dashboard: 'Главная', dailyPlanner: 'День', weeklyPlanner: 'Неделя', monthlyPlanner: 'Месяц', yearlyGoals: 'Цели', habitTracker: 'Привычки', notes: 'Заметки', analytics: 'Аналитика', achievements: 'Достижения', location: 'Карта', smartPlan: 'Умный план', pomodoro: 'Помодоро', journal: 'Дневник', matrix: 'Матрица', focus: 'Фокус', recurring: 'Повтор' },
  en: { dashboard: 'Main', dailyPlanner: 'Daily', weeklyPlanner: 'Weekly', monthlyPlanner: 'Monthly', yearlyGoals: 'Goals', habitTracker: 'Habits', notes: 'Notes', analytics: 'Analytics', achievements: 'Achievements', location: 'Map', smartPlan: 'Smart Plan', pomodoro: 'Pomodoro', journal: 'Kundalik', matrix: 'Matritsa', focus: 'Fokus', recurring: 'Takroriy' },
};
