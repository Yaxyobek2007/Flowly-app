          ...
          {mode === 'login' && (
            <form onSubmit={handleLogin} className="space-y-3">
              ...
              <div className="grid grid-cols-3 gap-2">
                <button type="button" onClick={handleGoogleLogin} className="flex flex-col items-center gap-1 p-2.5 rounded-xl bg-white/10 border border-white/20 hover:bg-white/20 transition-all relative">
                  ...
                  <span className="absolute -top-1 -right-1 w-3 h-3 bg-yellow-500 rounded-full text-[6px] text-white flex items-center justify-center font-bold">⏳</span>
                </button>
                <button type="button" onClick={handleGoogleLogin} className="flex flex-col items-center gap-1 p-2.5 rounded-xl bg-white/10 border border-white/20 hover:bg-white/20 transition-all relative">
