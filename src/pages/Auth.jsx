        ...
        <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl p-5 shadow-2xl">
          ...
          {mode === 'login' && (
            <form onSubmit={handleLogin} className="space-y-3">
              ...
              <p className="text-[9px] text-center text-yellow-300/60 flex items-center justify-center gap-1">⚠️ {language === 'ru' ? 'Google/iCloud откроют форму регистрации' : language === 'en' ? 'Google/iCloud will open signup form' : "Google/iCloud signup formaga o'tkazadi"}</p>
